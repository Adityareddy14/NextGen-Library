        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.email),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("li@gmail.com"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.phone),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("733"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.password),
                        childAtPosition(
                                ...
                                4),
                        isDisplayed()));
        appCompatEditText6.perform(replaceText("lik"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.conpassword),
                        childAtPosition(
                                ...
                                5),
                        isDisplayed()));
        appCompatEditText7.perform(replaceText("lik"), closeSoftKeyboard());
